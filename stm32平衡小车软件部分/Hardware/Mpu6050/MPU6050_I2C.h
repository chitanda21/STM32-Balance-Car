...
#define MPU6050_IIC_SCL_Pin                GPIO_Pin_4	         //PB4
#define MPU6050_IIC_SDA_Pin                GPIO_Pin_3	         //PB3

#define	MPU6050_IIC_SCL                    PBout(4)
#define	MPU6050_IIC_SDA                    PBout(3)  
#define	MPU6050_IIC_SDA_IN                 PBin(3)              //读数据端口
